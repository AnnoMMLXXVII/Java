...
public class AppointmentController implements Controller<Appointment> {
    ...
    private boolean isOverlappingAppointment(LocalDate date, LocalTime time) {
        ...
        ObservableList<Appointment> temp = (appointmentCopy != null) ? appointments.stream()
                .filter(e -> e.getAppointment_id() != appointmentCopy.getAppointment_id())
                .collect(Collectors.toCollection(FXCollections::observableArrayList)) : appointments;
