...
public class Tester2 {
	private final String col1 = "Product Code\t", col2 = "Product Name\t", col3 = "Unit Price\t",
			col4 = "Stock Available\t";
...
//				System.out.printf("%s\t %s\t %.2f\t\t %d\t\n", p.getProdCode(), p.getprodName(), p.getUnitPrice(),
//						p.getstockAvailable());
//			}
		}
	}
	...
	private void showOrderList() {
		if (orderList.size() == 0) {
			...
			for (Order o : this.orderList) {
				System.out.printf("%s\t\t%d\t\t%.2f\t\t%.2f\n", o.getProdCode(), o.getQuantity(), o.getUnitPrice(),
						o.getTotal());
			}
		}
	}
