...
public class ECommerceSystem {
	...
	public ECommerceSystem() {
		...
		products.add(
				new Book("Book", generateProductId(), 44.0, 14, 12, "Ahm Gonna Make You Learn More", "T. McInerney"));
		products.add(new Product("Rock Hammer", generateProductId(), 10.0, 22, Product.Category.GENERAL));

		products.add(new Shoe("ASICS", generateProductId(), 49.99, 1, Product.Category.SHOES, "BROWN", 7));
		products.add(new Shoe("ASICS", generateProductId(), 45.99, 1, Product.Category.SHOES, "BLACK", 7));
		products.add(new Shoe("Nike", generateProductId(), 79.99, 1, Product.Category.SHOES, "BLACK", 8));
...
//				check = null;
		...
		return check; // replace this line
	}
