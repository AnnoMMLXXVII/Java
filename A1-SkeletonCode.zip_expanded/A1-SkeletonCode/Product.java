...
//	}
	 ...
	 * will be overridden and will check to see if the options specified are valid
	 * for this product.
	 */
	...
	/*
	 * Return the number of items currently in stock for this product Note: in this
	 * general class, the productOptions parameter is not used. It may be used in
	 * subclasses.
	 */
	 ...
	 * when a product has been ordered by a customer) Note: in this general class,
	 * the productOptions parameter is not used. It may be used in subclasses.
	 */
	...
	/*
	 * Two products are equal if they have the same product Id. This method is
	 * inherited from superclass Object and overridden here
	 */
