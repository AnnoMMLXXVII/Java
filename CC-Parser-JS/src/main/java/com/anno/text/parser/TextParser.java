...
//    private static final String INLINE_NUMBER_DELIM = "\s[0-9]\\.+\s(([A-z]+\s)+)";
    ...
    private static final String REPLACE_TO_APOSTROPHE = "’";
    private static final String REMOVE_UNKNWON_1 = "�";
    private static final String REMOVE_UNKNWON_2 = "�";
    private static final String REMOVE_UNKNWON_3 = "�";
    private static final String REMOVE_UNKNWON_4 = "�";
